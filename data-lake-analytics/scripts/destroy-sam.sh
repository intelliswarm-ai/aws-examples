#!/bin/bash
# Destroy SAM application for Data Lake Analytics
set -e
...
STACK_NAME="data-lake-${ENV}"

echo "=========================================="
echo "Destroying Data Lake Analytics Stack: $STACK_NAME"
echo "=========================================="
...
for bucket_key in RawBucket ProcessedBucket ResultsBucket; do
