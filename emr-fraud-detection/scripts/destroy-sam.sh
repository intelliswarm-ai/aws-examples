#!/bin/bash
# Destroy SAM application for EMR Fraud Detection
set -e
...
STACK_NAME="fraud-detect-${ENV}"

echo "=========================================="
echo "Destroying EMR Fraud Detection Stack: $STACK_NAME"
echo "=========================================="
...
for bucket_key in DataBucket ModelsBucket LogsBucket; do
