#!/bin/bash
# Destroy SAM application for Call Center Analytics
set -e
...
STACK_NAME="call-sentiment-${ENV}"

echo "=========================================="
echo "Destroying Call Center Analytics Stack: $STACK_NAME"
echo "=========================================="
...
for bucket_key in TranscriptsBucket OutputBucket; do
